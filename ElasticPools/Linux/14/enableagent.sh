...
mkdir /var/log/azure/Microsoft.VisualStudio.Services.TeamServicesAgentLinux/_diag
chown AzDevOps:AzDevOps /var/log/azure/Microsoft.VisualStudio.Services.TeamServicesAgentLinux/_diag
